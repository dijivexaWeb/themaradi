          ...
          <div className="grid lg:grid-cols-[1fr_440px] gap-8 items-start">
            ...
            <div className="lg:sticky lg:top-24">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-11 h-11 bg-[#f8efd8] rounded-xl flex items-center justify-center text-xl shrink-0">🕯️</div>
                <div>
              ...
              <div className="rounded-xl border border-[#c9dfc9] bg-[#f2f7f0] p-4 mb-5">
                <span className="inline-block rounded-full bg-emerald-700 px-2.5 py-0.5 text-[10px] font-bold text-white uppercase tracking-wide mb-2.5">
                  {f.hostingBadge}
                </span>
                <div className="space-y-1.5 mb-2.5">
                  <div className="flex items-center gap-2 text-sm">
                    <span className="text-emerald-700 font-bold shrink-0">✓</span>
                    <span className="text-[#3d453f]">{f.hostingLine1}</span>
                  </div>
                </div>
                <div className="flex items-center gap-2 text-sm border-t border-[#c9dfc9] pt-2.5">
                  <span className="text-[#b08340] shrink-0">↻</span>
                  <span className="text-[#6f766f]">{hostingLine2}</span>
                </div>
                <p className="text-xs text-[#8a8478] mt-2 leading-5">
