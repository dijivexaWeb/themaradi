        ...
        <div className="max-w-xl w-full">
          ...
          <div className="border border-emerald-500/20 bg-slate-900 rounded-2xl p-6">
            ...
            <form action={action} className="space-y-4">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs text-slate-400 mb-1.5 font-medium">{c.profileLanguageLabel}</label>
              ...
              <div className="border border-slate-700/60 bg-slate-800/30 rounded-xl p-4 space-y-4">
                ...
                <p className="text-xs text-slate-600 leading-5 pt-1 border-t border-slate-700/50">
                  {c.consents.kvkkNote}{' '}
                  <Link href="/kvkk" className="text-emerald-400/70 hover:text-emerald-400 underline underline-offset-2">{c.consents.kvkkLink}</Link>
                </p>
              </div>
