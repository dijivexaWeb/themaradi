...
export default function KasaSatinAlPage() {
        ...
        <div className="border border-emerald-500/20 bg-slate-900 rounded-2xl p-7">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Kurulum ücreti — havale ile ödeme</p>
            </div>
          </div>
          ...
          <div className="bg-slate-800/60 border border-slate-700 rounded-xl p-4 mb-6">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-mono text-emerald-400 select-all">{IBAN}</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between pt-2 border-t border-slate-700">
                ...
                <span className="text-white font-bold text-base">49 ₾</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-400">Aylık ücret</span>
                <span className="text-slate-300">12.90 ₾/ay (aktivasyondan sonra)</span>
              </div>
            </div>
          </div>
          ...
          <form action={action} className="space-y-4">
            <div>
              ...
              <input
                type="text"
                name="display_name"
                placeholder="Örn: Benim Kasam veya kendi adınız"
                required
