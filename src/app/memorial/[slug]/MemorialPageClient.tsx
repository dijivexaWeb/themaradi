...
const memorialCopy: Record<Lang, typeof memorialCopyBase.tr> = {
  ...
  hy: {
    ...memorialCopyBase.en,
    nav: { home: 'Գլխավոր', how: 'Ինչպես է աշխատում', memorials: 'Թվային հիշատակներ', contact: 'Կապ', start: 'Սկսել' },
    hero: { imageAlt: 'Հիշատակի տարածք', portraitAlt: 'Ահմեդ Յըլմազ', qr: 'Մուտք QR-ով', badge: 'Թվային հիշատակի պրոֆիլ', motto: 'Ապրեց սերով, հիշվում է սերով:', familyTitle: 'Ընտանիքից', familyNote: 'Հարգանքով հիշում ենք նրան: Համբերությունը, բարությունը և սերը, որ նա մեզ թողեց, մինչ օրս լուսավորում են մեր ճանապարհը: Նա մեզ հետ է յուրաքանչյուր աղոթքում, սեղանի շուրջ և ամեն մի ջերմ հիշողության մեջ:', messageTitle: 'Նրա խոսքերը', messageNote: 'Հասկացա, որ կյանքում ամենաարժեքավորը սերն է: Եղեք բարի միմյանց հանդեպ, խոսեք առանց վնասելու և հետևեք բարությանը:', sinceLabel: 'Հավերժությանը գնալուց ի վեր', sinceSuffix: 'օր է անցել', book: 'Հիշողությունների գիրք', explore: 'Տեսնել հիշողությունները', scroll: 'Ոլորել', yearsLine: 'տարվա լի և օրհնված կյանք' },
    stats: [
      { suffix: 'տարի', label: 'Օրհնված կյանք' },
      { number: '55', suffix: 'տարի', label: 'Ամուսնություն' },
      { number: '3 զավակ', suffix: '7 թոռ', label: 'Թողած սերունդ' },
      { number: '2 700+', suffix: 'աշակերտ', label: 'Դաստիարակած մարդիկ' },
    ],
    tabs: ['Կյանքի պատմություն', 'Ժամանակագրություն', 'Տեսանյութեր', 'Լուսանկարներ', 'Վերջին մեսիջ', 'Ցավակցություն', 'Այցելություն'],
    story: {
      label: 'Կյանքի պատմություն',
      titleA: 'Ուսուցչի',
      titleB: 'լի կյանքը:',
      paragraphs: [
        'Ահմեդ Յըլմազը ծնվել է 1940 թվականին Կոնիայի պատմական միջավայրում, համեստ ընտանիքում: Մանկուց գրքերի և սովորելու հանդեպ սերը նրան առանձնացրել է հասակակիցներից: Թաղամասի դպրոցում ստացած առաջին դասերը նրա մեջ վառեցին ողջ կյանքի լույսը:',
        'Երբ Անկարայում մանկավարժական դպրոցն ավարտեց և սկսեց աշխատել, ընդամենը տասնութ տարեկան էր: Բազմամարդ դասարաններում, հին նստարանների մոտ և ածխի վառարանի կողքին դասեր անցկացնելիս երբեք չէր գանգատվում: Ասում էր. «Մարդ որքան շատ տալիս, այնքան ավելի հարստանում է»: Եւ իրապես այդպես ապրեց:',
        '1965 թվականին ֆաթմայի հետ ստեղծած ընտանիքը նրա համար ամեն ինչի կենտրոնն էր: Երեք զավակ և յոթ թոռ եղան ամենագեղեցիկ ժառանգությունը, որ թողեց աշխարհին: Կենսաթոշակ անցնելուց հետո տարիները անցկացրեց պարտեզում, թոռների և գրքերի հետ: Ամեն առավոտ սկսվում էր աղոթքով, ամեն երեկո ավարտվում էր երախտագիտությամբ:',
      ],
      quote: 'Նրա առավոտյան աղոթքը երբեք չէր փոխվում: Հիսուն տարի նույն աղոթքը, նույն ձայնը, նույն խաղաղությունը: Առանց այդ ձայնի առավոտները մինչ օրս չեմ կարողանում լրացնել:',
      relation: 'Կին — 55 տարի միասին',
      books: 'Կարդացած գիրք',
      teaching: 'Տարի ուսուցչությունից',
    },
    timelineLabel: 'Կյանքի ժամանակագրություն',
    timelineTitleA: 'Ուղևորություն կարևոր',
    timelineTitleB: 'պահերում:',
    timelineEvents: [
      { year: '1940', title: 'Ծնվեց', desc: 'Ծնվել է համեստ ընտանիքում, Կոնիայի պատմական միջավայրում: Մանկուց աչքի էր ընկնում գրքերի և գիտելիքի հանդեպ սերով:' },
      { year: '1958', title: 'Սկսեց ուսուցչի ուղին', desc: 'Տեղափոխվեց Անկարա և լավագույն արդյունքով հանձնեց ուսուցչի քննությունը: Ասում էր. «Մարդկանց սովորեցնելը՝ նրանց լույս տալն է»:' },
      { year: '1965', title: 'Կապեց կյանքը ֆաթմայի հետ', desc: 'Նրանք ճանապարհ բռնեցին, որով 55 տարի անցկացրին միասին: Անկարայում համեստ հարսանիքով սկսված այս ուղևորությունը շարունակվեց ողջ կյանքում:' },
      { year: '1967', title: 'Հայր դարձավ', desc: 'Ծնվեց առաջին որդին՝ Հասանը: Հետագա տարիներին ընտանիքին միացան Զեյնեփը և Ալին: Երեք զավակ և յոթ թոռ դարձան նրա մեծագույն ժառանգությունը:' },
      { year: '1985', title: 'Անցավ կենսաթոշակի', desc: '27 տարվա ընթացքում դաստիարակեց հազարավոր աշակերտներ: Վերջին օրը ողջ դպրոցը հավաքվեց հրաժեշտ տալու: Ոչ ոք չկարողացավ զսպել արցունքները:' },
      { year: '2020', title: 'Միացավ հավերժությանը', desc: 'Ութսուն տարվա օրհնված կյանքից հետո խաղաղորեն հրաժեշտ տվեց սիրելիների շրջապատում: Թողեց անհամար հիշողություններ և խորին սեր:' },
    ],
    videos: { label: 'Տեսանյութ հիշողություններ', titleA: 'Շարժվող', titleB: 'պահեր:', featured: 'Ընտրված', demo: 'Այս տեսանյութերը նմուշային նպատակով են:' },
    videoMemories: ['70-ամյակի տոնակատարություն', 'Վերջին տոնը թոռների հետ', 'Ուղևորություն Վրաստան', 'Կենսաթոշակի արարողություն'],
    photos: { label: 'Լուսանկարների արխիվ', titleA: 'Սառեցված պահեր,', titleB: 'կենդանի հիշողություններ:', count: 'լուսանկար' },
    photoTitles: ['Առաջին ընտանեկան լուսանկար', 'Տոնական սեղան', 'Ուղևորություն Վրաստան', 'Վերջին ընտանեկան լուսանկար', 'Կեսօր պարտեզում', 'Կենսաթոշակի տարիներ'],
    finalMessage: {
      label: 'Վերջին մեսիջ',
      titleA: 'Ողջ ժամանակ թողած',
      titleB: 'խոսքերը սիրելիների համար:',
      lines: ['Իմ սիրելիներ,', 'Հասկացա, որ կյանքում ամենաարժեքավորը սերն է: Չնայեք նրան, ինչ ունեք. նայեք մարդկանց, որ կողքիդ են: Իրական հարստությունը նրանց մեջ է:', 'Միշտ բարությամբ վերաբերվեք միմյանց: Խոսեք առանց վնասելու և օգնեք, որքան կարող եք: Փոքրիկ բարությունն անգամ լուսավորում է մեծ խավարը:', 'Հիշեք, ես միշտ ձեզ հետ եմ: Ամեն աղոթքում, ամեն բույրում և ամեն կիսված սեղանի շուրջ ես կողքիդ կլինեմ:', 'Մնացեք սերով:'],
      placeDate: 'Կոնիա, 12 մարտի 2020',
    },
    voices: { label: 'Ձայնային հիշողություններ', titleA: 'Նրա ձայնը', titleB: 'դեռ այստեղ է:', demo: 'Նմուշային ձայնագրություն' },
    voiceMemories: [
      { title: 'Առավոտյան աղոթք', author: 'Ահմեդ բեյի ձայնով' },
      { title: 'Կտակ թոռներին', author: 'Ահմեդ բեյի ձայնով' },
      { title: 'Հայրը միշտ մեզ հետ էր', author: 'Պատմում է դուստրը՝ Զեյնեփը' },
    ],
    featured: { label: 'Ընտրված հիշողություններ', titleA: 'Սիրելիների', titleB: 'խոսքերով:' },
    featuredMemories: [
      { quote: 'Միշտ վաղ էր արթնանում և սուրճի ընթացքում երբեք չէր բաց թողնում աղոթքը: Առանց այդ ձայնի առավոտներն այսօր էլ կարոտում եմ:', author: 'Զեյնեփ Յըլմազ', relation: 'Դուստր' },
      { quote: 'Նա մեզ սովորեցրեց ոչ միայն դասը, այլ կյանքը: Տախտակին գրված ամեն մի նախադասություն կյանքի դաս էր: Երբեք չենք մոռանա նրան:', author: 'Մեհմեդ Արսլան', relation: 'Նախկին աշակերտ' },
      { quote: 'Երբ ձեռքս բռնում էր, թվում էր, թե աշխարհը կանգ առավ: Այսպիսի վստահություն ուրեք չկար: Այսպես անցավ հիսունհինգ տարի:', author: 'ֆաթմա Յըլմազ', relation: 'Կին' },
    ],
    condolences: [
      { name: 'Այշե Դեմիր', date: '20 մայիսի 2024', relation: 'Հարևան', text: 'Աստված ողորմած լինի մեր ուսուցիչ Ահմեդին: Թող լույս լինի նրա հոգին: Նա մարդկայնության օրինակ էր, և բոլորը սիրում էին նրան:' },
      { name: 'Մեհմեդ Արսլան', date: '18 մայիսի 2024', relation: 'Աշակերտ', text: 'Հարգարժան ուսուցիչ, որպես ձեր աշակերտներից մեկը, երբեք չեմ մոռանա ձեզ: Հանգստացեք լույսի մեջ:' },
      { name: 'ֆաթմա Քայա', date: '16 մայիսի 2024', relation: 'Հարևան', text: 'Ձեր ազնվությունն ու բարությունը միշտ կհիշվեն: Գեղեցիկ հիշողություններ թողեցիք մեզ:' },
      { name: 'Սելիմ Յըլդըզ', date: '15 մայիսի 2024', relation: 'Ազգական', text: 'Աստված ողորմած լինի Ահմեդ հորեղբորը, նրա մերձավորներին համբերություն և ուժ եմ ցանկանում:' },
    ],
    visit: { label: 'Այցելության տվյալներ', titleA: 'Այցելություն', titleB: 'գերեզմանին:', imageAlt: 'Ահմեդ Յըլմազի գերեզմանը', cemeteryLine: '1940 - 2020 · Ուչլեր գերեզմանատուն, Կոնիա', infoTitle: 'Գերեզմանի տվյալներ', cemetery: 'Գերեզմանատուն', plot: 'Հատված / Մաս', row: 'Շարք / Համար', hours: 'Այցելության ժամեր', cemeteryValue: 'Ուչլեր գերեզմանատուն, Կոնիա', plotValue: 'Հատված: 245 · Մաս: 18', rowValue: 'Շարք: C · Գերեզման թիվ: 7', hoursValue: 'Ամեն օր 08:00 - 19:00', noteLabel: 'Նշում:', note: 'Այցելուների համար հասանելի են հարմարավետ զբոսաշրջային ուղիներ: Գլխավոր մուտքից շարժվեք D դարպասի ուղղությամբ; C շարքը 50 մետր է:', mapTitle: 'Գերեզմանատան դիրք' },
    footer: { motto: 'Հիշողություններն ապրում են, մեծ սերն անվերջ է:', platform: 'Հարթակ', corporate: 'Կորպորատիվ', documents: 'Փաստաթղթեր', home: 'Գլխավոր', demo: 'Նմուշ պրոֆիլ', pricing: 'Գներ', about: 'Մեր մասին', contact: 'Կապ', privacy: 'Գաղտնիություն', terms: 'Օգտագործման պայմաններ', kvkk: 'KVKK', rights: '© 2026 The Eternal Memory. Բոլոր իրավունքները պաշտպանված են:' },
...
export default function MemorialPage() {
  ...
  const familyUi = {
    ...
    hy: {
      label: 'Ընտանեկան կապեր',
      titleA: 'Արմատներից',
      titleB: 'նոր սերունդներին:',
      tabTree: 'Ընտանեկան ծառ',
      tabClose: 'Մերձավոր ընտանիք',
      generation: 'սերունդ',
      protected: 'Այս ընտանեկան կապը պահպանված է The Eternal Memory-ով:',
      people: [
        { name: 'Մեհմեդ Յըլմազ', relation: 'Հայր', years: '1915 - 1988', initials: 'MY', image: '/images/landing/profile-family-old.png', position: '35% 32%' },
        { name: 'Այշե Յըլմազ', relation: 'Մայր', years: '1918 - 1995', initials: 'AY', image: '/images/landing/profile-family-old.png', position: '68% 34%' },
        { name: 'Ահմեդ Յըլմազ', relation: 'Պրոֆիլ', years: '1940 - 2020', initials: 'AY', image: '/images/landing/memorial-ahmet.png', position: '50% 18%', featured: true },
        { name: 'Ֆաթմա Յըլմազ', relation: 'Կին', years: '1945 -', initials: 'FY', image: '/images/landing/profile-family-main.png', position: '62% 28%' },
        { name: 'Հասան Յըլմազ', relation: 'Որդի', years: '1966 -', initials: 'HY', image: '/images/landing/profile-family-dinner.png', position: '35% 28%' },
