...
const interactionCopy: Record<Lang, InteractionCopy> = {
  ...
  he: {
    title: 'שתפו', titleAccent: 'את רגשותיכם.', candle: 'הדלק נר', candleDone: 'הנר הודלק', flower: 'השאר פרח', flowerDone: 'הפרח הושאר', prayer: 'התפלל', prayerDone: 'התפילה נשלחה', candleUnit: 'נרות', flowerUnit: 'פרחים', prayerUnit: 'תפילות', ctaTitle: 'האם תרצו להשאיר מסר תנחומים?', notableCtaTitle: 'תוכלו לשתף כמה מילות הוקרה.', ctaText: 'הודעתכם תתפרסם לאחר אישור היורשים.', notableCtaText: 'השאירו מסר קצר של כבוד.', messageButton: 'השאר הודעה', formTitle: 'מסר התנחומים שלכם', formText: 'יופיע בדף לאחר אישור.', name: 'שמכם', namePlaceholder: 'שם מלא', relation: 'קשר', relationPlaceholder: 'שכן, תלמיד, ...', message: 'הודעתכם', messagePlaceholder: 'כתבו כאן את מסר התנחומים שלכם...', send: 'שלח', cancel: 'בטל', optional: 'אופציונלי', contact: 'יצירת קשר', contactOptional: 'אופציונלי · נשלח למשפחה', contactPlaceholder: 'דוא"ל או טלפון', contactHelp: 'פרטי יצירת הקשר נשלחים למשפחה בלבד ואינם מוצגים בדף.', anonymous: 'המשך באנונימיות',
    actions: { candle: { emoji: '🕯️', title: 'אתם מדליקים נר', desc: 'כל נר מאיר זיכרון אחד.', confirmLabel: 'הדלק נר', color: 'amber' }, flower: { emoji: '🌹', title: 'אתם משאירים פרח', desc: 'כל פרח הוא ביטוי של כבוד עמוק.', confirmLabel: 'השאר פרח', color: 'rose' }, prayer: { emoji: '🤲', title: 'אתם מתפללים', desc: 'כל תפילה מהדהדת אהבה וגעגוע.', confirmLabel: 'התפלל', color: 'gold' } }
  },
}
