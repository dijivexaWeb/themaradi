const en = {
  ...
  purchasePage: {
    common: {
      ...
      whatsappBoxHeading: 'Continue on WhatsApp',
      whatsappBoxBody: 'Fill out the form to create your order. Then reach us on WhatsApp to complete the payment personally.',
      amountLabel: 'Amount',
      dataSecurityBadge: 'Data Security',
      submitCta: 'Create Order & Continue on WhatsApp →',
      profileForLabel: 'Who is this profile for?',
      profileForOptions: { baba: 'My father', anne: 'My mother', es: 'My spouse', kardes: 'My sibling', yakin: 'A loved one', diger: 'Other' },
      profileLanguageLabel: 'Profile language',
      profileLanguageOptions: { tr: 'Turkish', ka: 'Georgian', ru: 'Russian', en: 'English' },
      consents: {
        heading: 'Permissions & Disclosure',
        privacyNoticeAck: 'I have read the Privacy Notice.',
        privacyNoticeAckDesc: 'Informs you how your personal data is processed; this is not a consent statement.',
        privacyNoticeLinkText: 'Read the Privacy Notice →',
        dataProcessingConsent: 'I consent to my information being used to create my order, open my account, and be contacted.',
        dataProcessingConsentDesc: 'Order confirmation, payment status, and account security notices are sent by email/phone.',
    ...
    anma: {
      ...
      footerNote: 'After creating your order, complete the payment on WhatsApp.',
      success: {
