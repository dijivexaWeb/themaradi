const en = {
  ...
  purchasePage: {
    ...
    aile: {
      ...
      bankTransfer: { name: 'Bank Transfer', status: '✓ Active' },
      bankDetails: { heading: 'Transfer Details', ibanLabel: 'IBAN', bankLabel: 'Bank', recipientLabel: 'Recipient', amountLabel: 'Amount' },
      form: {
      ...
      submitBtn: "I've Sent the Transfer, Create My Family Page →",
      submitPending: 'Processing...',
      footerNote: 'Fill in this form after making the transfer. Your family panel will be activated within 24 hours once our team confirms payment.',
      success: {
        title: 'Verify your email',
        emailSentTo: 'We sent a verification link to',
