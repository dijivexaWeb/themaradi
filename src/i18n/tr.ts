...
const tr: LangDict = {
  ...
  purchasePage: {
    common: {
      ...
      whatsappBoxHeading: "WhatsApp'tan Devam Edin",
      whatsappBoxBody: 'Formu doldurun, siparişiniz oluşturulsun. Ardından WhatsApp üzerinden bize ulaşarak ödemeyi kişisel olarak tamamlarsınız.',
      amountLabel: 'Tutar',
      dataSecurityBadge: 'Veri Güvenliği',
      submitCta: "Siparişi Oluştur ve WhatsApp'tan Devam Et →",
      profileForLabel: 'Bu profil kimin için?',
      profileForOptions: { baba: 'Babam için', anne: 'Annem için', es: 'Eşim için', kardes: 'Kardeşim için', yakin: 'Yakınım için', diger: 'Diğer' },
      profileLanguageLabel: 'Profil dili',
      profileLanguageOptions: { tr: 'Türkçe', ka: 'Gürcüce', ru: 'Rusça', en: 'İngilizce' },
      consents: {
        heading: 'İzinler & Aydınlatma',
        privacyNoticeAck: "Aydınlatma Metni'ni okudum.",
        privacyNoticeAckDesc: 'Kişisel verilerinizin nasıl işlendiğini anlatan bilgilendirme metnidir, rıza niteliği taşımaz.',
        privacyNoticeLinkText: "Aydınlatma Metni'ni Oku →",
        dataProcessingConsent: 'Siparişimin oluşturulması, hesabımın açılması ve benimle iletişime geçilmesi için bilgilerimin kullanılmasını kabul ediyorum.',
        dataProcessingConsentDesc: 'Sipariş onayı, ödeme durumu ve hesap güvenliği bildirimleri e-posta/telefon ile iletilir.',
    ...
    anma: {
      ...
      footerNote: 'Siparişinizi oluşturduktan sonra WhatsApp üzerinden ödemeyi tamamlayın.',
      success: {
