...
const tr: LangDict = {
  ...
  landing: {
    hero: {
      eyebrow: '',
      h1a: 'Vefat Eden Yakınlarınızı Dijital',
      h1b: 'Dünyada Sonsuza Kadar Yaşatın.',
  ...
  purchasePage: {
    ...
    aile: {
      ...
      bankTransfer: { name: 'Banka Havalesi', status: '✓ Aktif' },
      bankDetails: { heading: 'Havale Bilgileri', ibanLabel: 'IBAN', bankLabel: 'Banka', recipientLabel: 'Alıcı', amountLabel: 'Tutar' },
      form: {
      ...
      submitBtn: 'Havale Yaptım, Aile Sayfamı Oluştur →',
      submitPending: 'İşleniyor...',
      footerNote: 'Havaleyi gönderdikten sonra bu formu doldurun. Ekibimiz ödemeyi doğruladıktan sonra aile paneliniz 24 saat içinde aktive edilir.',
      success: {
        title: 'E-postanızı doğrulayın',
        emailSentTo: 'adresine bir doğrulama bağlantısı gönderdik.',
